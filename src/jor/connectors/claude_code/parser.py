"""Parse Claude Code JSONL records into JorMessage objects.
...
def extract_metadata(records: list[dict], session_path: Path) -> dict:
    """Extract session metadata from Claude Code records."""
...
def parse_record(record: dict, source_id: str) -> JorMessage | list[JorMessage] | None:
    """Convert a single Claude Code record to JorMessage(s). Returns None to skip."""
